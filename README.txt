...
This project is hosted on `bitbucket.org <https://bitbucket.org/sprat/yaak.inject/>`__.
Please report issues via the bug tracker.

The package documentation can be found `here <http://packages.python.org/yaak.inject/>`__.
